...
export const campaignSchema = z.object({
  ...
  baseline_evidence_id: z.string().nullable().optional(),
  completion_evidence_id: z.string().nullable().optional(),
...
export const campaignResponseSchema = z.object({
  ...
  baselineEvidenceId: z.string().nullable(),
  completionEvidenceId: z.string().nullable(),
